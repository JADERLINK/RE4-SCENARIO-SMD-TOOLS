        ...
        public static void Convert(IdxMtl idxmtl, out IdxMaterial idxMaterial)
        {
            ...
            foreach (var item in idxmtl.MtlDic.OrderBy(a => a.Key).ToArray())
            {
                ...
                if (item.Value.map_d != null)
                {
                    ...
                    mat.opacity_map = item.Value.map_d.TextureID;
                }
                ...
                if (item.Value.ref_specular_map != null)
                {
                    ...
                    if (item.Value.ref_specular_map.FolderName.ToLowerInvariant() == "generic_specular")
                    {
                    ...
                    else
                    {
                        ...
                        mat.generic_specular_map = 0;
                        mat.custom_specular_map = item.Value.ref_specular_map.TextureID;
                    }
                }
